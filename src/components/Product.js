  ...
  return (
    <div ref={productRef} className="flex flex-col gap-6 items-center">
      ...
      <div className="flex flex-col gap-6 items-center py-16 px-6 md:px-20 w-full bg-red-50 ">
        <div className="grid sm:grid-cols-5 grid-cols-3 justify-center gap-9 sm:max-w-6xl h-full mx-auto">
            ...
            <div
              ...
              className={
                selectedProduct?.id === product.id
                  ? "flex flex-col justify-center items-center text-center  w-full sm:w-full h-full mx-auto  relative cursor-pointer"
                  : "flex flex-col justify-center items-center text-center  cursor-pointer"
              }
            >
              <div className={selectedProduct?.id === product.id
                  ? "flex flex-col justify-center items-center text-center w-full sm:w-full h-full mx-auto my-auto bg-white rounded-md p-2"
                  : ""}>
                <img
                  ...
                  className={
                    selectedProduct?.id === product.id
                      ? "sm:max-w-4xl w-1/2 h-1/2  rounded-md"
